...
export default function PricingCard({ tier, index = 0 }: PricingCardProps) {
  return (
    ...
    >
      ...
      {/* Regular badge (only if no comingSoon) */}
      ...
      {tier.comingSoon ? (
        <button
          disabled
          className="w-full flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-semibold text-sm bg-muted/30 border border-border text-muted-foreground cursor-not-allowed select-none"
        >
