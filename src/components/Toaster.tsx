      ...
      >
        {toasts.map(t => {
          ...
          return (
            <div
              key={t.id}
              className={`pointer-events-auto flex items-start gap-3 px-4 py-3 rounded-xl border ${colors.container} backdrop-blur-md shadow-xl shadow-black/30 min-w-[260px] max-w-xs transition-all duration-200 ease-out`}
            >
