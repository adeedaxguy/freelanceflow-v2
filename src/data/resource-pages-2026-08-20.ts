...
export const AUGUST_20_2026_RESOURCE_PAGES: ResourcePage[] = [
  ...
  buildResourcePage({
    ...
    title: "Web Design Lead Generation Workflow",
    ...
    audience: "Web designers, WordPress developers, Webflow freelancers, Shopify developers, and small website agencies",
    intent: "The searcher wants a repeatable way to find businesses that may need website, redesign, booking, SEO, or conversion work.",
    searcherJob: "Turn web design prospecting into a qualified lead workflow instead of buying a blind shared list.",
    competitorGap: "Lead sellers tend to emphasize list volume, exclusivity, or pricing. This page wins by showing how to verify the website gap, buyer fit, source proof, and respectful contact route before any outreach is drafted.",
    workflowNudge: "Start with one city, one service category, and one website problem, then save only prospects with visible proof and a first-message angle.",
    conversionPath: "Signup, run a web design lead search, save proof-backed prospects, draft a web design pitch, and schedule follow-up.",
    leadIn: "Use this workflow when you want web design leads that can support a specific pitch, not a spreadsheet full of companies you cannot honestly help.",
    pitch: "Hi, I found your business while researching web design lead generation opportunities in your market. I noticed one website path that could make it easier for customers to call, book, or request a quote, and I can send a short idea if helpful.",
  }),
  buildResourcePage({
