...
const INTEGRATIONS = [
  {
    ...
    bg:       "bg-accent/10",
    border:   "border-accent/20",
    desc:     "Powers AI proposals, Deal Closer & follow-ups. Free tier: 14,400 req/day.",
    settingKey: "groq_api_key",
    placeholder: "gsk_…",
    docsUrl:  "https://console.groq.com/keys",
    docsLabel:"Get free Groq key →",
    hint:     "Sign up at console.groq.com — 100% free.",
  },
  {
    id:       "yelp",
    label:    "Yelp Fusion",
    ...
    desc:     "Adds ratings, reviews & phone numbers to Local Business Leads. Free: 500 calls/day.",
    settingKey: "yelp_api_key",
    placeholder: "yelp_…",
    docsUrl:  "https://www.yelp.com/developers/v3/manage_app",
    docsLabel:"Get free Yelp key →",
    hint:     "Create a free app at yelp.com/developers.",
  },
  {
    id:       "foursquare",
    ...
    desc:     "Phone numbers, ratings & hours for local businesses. Free: 1,000 calls/day. Global.",
    settingKey: "foursquare_api_key",
    placeholder: "fsq3…",
    docsUrl:  "https://foursquare.com/developer",
    docsLabel:"Get free Foursquare key →",
    hint:     "Sign up at foursquare.com/developer — free, no credit card.",
  },
  {
    id:       "tomtom",
    label:    "TomTom Places",
    ...
    desc:     "Business phone, website & hours. Excellent EU & Middle East coverage. Free: 2,500 calls/day.",
    settingKey: "tomtom_api_key",
    placeholder: "…",
    docsUrl:  "https://developer.tomtom.com",
    docsLabel:"Get free TomTom key →",
    hint:     "Sign up at developer.tomtom.com — free 2,500 requests/day.",
  },
  {
    id:       "geoapify",
    ...
    desc:     "Global POI database with business categories & addresses. Free: 3,000 calls/day.",
    settingKey: "geoapify_api_key",
    placeholder: "…",
    docsUrl:  "https://myprojects.geoapify.com",
    docsLabel:"Get free Geoapify key →",
    hint:     "Sign up at myprojects.geoapify.com — free, no credit card.",
  },
  {
    id:       "radar",
    label:    "Radar.io",
    ...
    desc:     "Places search with business names, categories & addresses. Free: 100,000 req/month.",
    settingKey: "radar_api_key",
    placeholder: "prj_live_…",
    docsUrl:  "https://radar.com/dashboard",
    docsLabel:"Get free Radar key →",
    hint:     "Use the Secret Key from radar.com/dashboard — 100k free/month.",
  },
  {
    id:       "bing",
    label:    "Bing Local Search",
    icon:     "🔍",
    color:    "text-blue-400",
    bg:       "bg-blue-500/10",
    border:   "border-blue-500/20",
    desc:     "Microsoft Maps business data — phone, website, ratings. Free: 10,000 transactions/month.",
    settingKey: "bing_maps_key",
    placeholder: "…",
    docsUrl:  "https://www.bingmapsportal.com",
    docsLabel:"Get free Bing key →",
    hint:     "Create a Basic key at bingmapsportal.com — free 10k/month.",
  },
  {
    id:       "companies-house",
    ...
    desc:     "Every registered UK business — name, address, directors, status. Completely free & unlimited.",
    settingKey: "companies_house_key",
    placeholder: "…",
    docsUrl:  "https://developer.company-information.service.gov.uk",
    docsLabel:"Get free Companies House key →",
    hint:     "Register at developer.company-information.service.gov.uk — 100% free, no limits.",
  },
  {
    id:       "hunter",
    label:    "Hunter.io",
    ...
    bg:       "bg-primary/10",
    border:   "border-primary/20",
    desc:     "Finds and verifies contact emails for companies you discover. Free: 25 searches/mo.",
    settingKey: "hunter_api_key",
    placeholder: "hnt_…",
    docsUrl:  "https://hunter.io/api-keys",
    docsLabel:"Get Hunter key →",
    hint:     "Free plan includes 25 searches/month.",
  },
];
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-2xl p-4 sm:p-5 flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5 leading-relaxed">
                Connect your own free API keys to unlock features. Keys are stored encrypted and only used on your account — never shared.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gradient-card border border-border rounded-2xl p-4 sm:p-5">
            ...
            <div className="space-y-2">
              {[
                ...
                "Groq free tier gives you 14,400 AI proposal generations per day",
                "Yelp free tier provides 500 local business searches with phone numbers",
                "Hunter.io lets you find verified emails for any business domain",
              ].map(tip => (
