...
export default async function AdminEmailsPage() {
  ...
  return (
    <div className="p-6 lg:p-8 space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-foreground">All Sent Emails</h1>
        <p className="text-muted-foreground mt-1">{total.toLocaleString()} total emails sent platform-wide</p>
      </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-border bg-background/50">
                {["User", "Recipient Company", "Subject", "Sent At", "Status"].map(h => (
